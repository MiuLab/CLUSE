...
en_srl = sense_representation_learning(en_emb.s_in, en_emb.s_out, en_dh.sense_counts, samp_size, lr_rate, de_dh.sense_counts, de_emb.s_in)
de_srl = sense_representation_learning(de_emb.s_in, de_emb.s_out, de_dh.sense_counts, samp_size, lr_rate, en_dh.sense_counts, en_emb.s_in)
...
def evaluate_bcws(sess, en_dh, de_dh, batch_size, en_ss, de_ss, en_srl, de_srl):
    ...
    [de_senseVec, de_senseScore] = getEmbedding(sess, de_dh, batch_size, de_ss, de_srl.embedded_sense_input, de_srl.selected_sense_input_indices)
    
    assert en_dh.test_score == de_dh.test_score
    avgSimC = calAvgSimC(en_dh.test_score, en_senseVec, en_senseScore, de_senseVec, de_senseScore)
    maxSimC = calMaxSimC(en_dh.test_score, en_senseVec, en_senseScore, de_senseVec, de_senseScore)
