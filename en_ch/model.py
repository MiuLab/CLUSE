...
class sense_representation_learning(object):
    def __init__(self, s_in, s_out, sense_counts, samp_size, learning_rate, bi_sense_counts, bi_s_mat):
        with tf.device("/cpu:0"):
            ...
            self.embedded_sense_input_l2 = tf.nn.l2_normalize(embedded_sense_input, axis=1)
            ...
            self.embedded_sense_output_l2 = tf.nn.l2_normalize(embedded_sense_output, axis=1)
